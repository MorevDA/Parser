...
def get_json():
    """Функция отправляет post запрос к api компании БКС и получет json содержащий актуальную цену по всем акциям
    торгующимся на ММВБ. Информация во время проведения торговой сессии поступает с 15-ти минутной задержкой,
